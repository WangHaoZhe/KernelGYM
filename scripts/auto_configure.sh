...
ENABLE_NCU_PROFILING="${ENABLE_NCU_PROFILING:-true}"
NCU_PATH="${NCU_PATH:-your-ncu-path e.g: /usr/local/NVIDIA-Nsight-Compute-2025.2}"
SU_PWD="${SU_PWD:-your-root-password}"
NCU_METRICS_PATH="${NCU_METRICS_PATH:-ncu_metrics.json}"
...
NCU_PATH=${NCU_PATH}
SU_PWD=${SU_PWD}
NCU_METRICS_PATH=${NCU_METRICS_PATH}
