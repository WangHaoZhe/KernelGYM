...
- `source_id`: `triton_tutorial_layer_norm`
- `url`: https://triton-lang.org/main/getting-started/tutorials/05-layer-norm.html
- `category`: `triton_tutorial`
- `num_chunks`: `1`
- `tags`: `triton, layernorm, reduction`

## Chunk 0

- `chunk_id`: `triton_tutorial_layer_norm::chunk::0`
- `token_estimate`: `1966`
- `word_count`: `1931`
