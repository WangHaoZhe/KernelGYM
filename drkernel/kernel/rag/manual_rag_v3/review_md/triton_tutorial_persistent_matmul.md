# Persistent Matmul — Triton  documentation

- `source_id`: `triton_tutorial_persistent_matmul`
- `url`: https://triton-lang.org/main/getting-started/tutorials/09-persistent-matmul.html
- `category`: `triton_tutorial`
- `num_chunks`: `1`
- `tags`: `triton, matmul, persistent`

## Chunk 0

- `chunk_id`: `triton_tutorial_persistent_matmul::chunk::0`
- `token_estimate`: `2891`
- `word_count`: `2877`
