...
- `source_id`: `triton_tutorial_fused_softmax`
- `url`: https://triton-lang.org/main/getting-started/tutorials/02-fused-softmax.html
- `category`: `triton_tutorial`
- `num_chunks`: `1`
- `tags`: `triton, softmax, reduction`

## Chunk 0

- `chunk_id`: `triton_tutorial_fused_softmax::chunk::0`
- `token_estimate`: `1325`
- `word_count`: `1325`
